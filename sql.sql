...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ kakuga-database /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE SEQUENCE active_storage_attachments_seq;

CREATE TABLE active_storage_attachments (
  id bigint NOT NULL DEFAULT NEXTVAL ('active_storage_attachments_seq'),
...
ALTER SEQUENCE active_storage_attachments_seq RESTART WITH 118;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE SEQUENCE active_storage_blobs_seq;

CREATE TABLE active_storage_blobs (
  id bigint NOT NULL DEFAULT NEXTVAL ('active_storage_blobs_seq'),
...
ALTER SEQUENCE active_storage_blobs_seq RESTART WITH 118;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE episodes (
  id bigint NOT NULL DEFAULT NEXTVAL ('episodes_seq'),
  name text,
  description text,
...
ALTER SEQUENCE episodes_seq RESTART WITH 35;
/*!40101 SET character_set_client = @saved_cs_client */;

CREATE INDEX index_episodes_on_user_id ON episodes (user_id);
CREATE INDEX index_episodes_on_title_id ON episodes (title_id);
CREATE INDEX index_episodes_on_season_id ON episodes (season_id);
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE SEQUENCE friendly_id_slugs_seq;

CREATE TABLE friendly_id_slugs (
  id int NOT NULL DEFAULT NEXTVAL ('friendly_id_slugs_seq'),
  ...
  PRIMARY KEY (id),
  CONSTRAINT index_friendly_id_slugs_on_slug_and_sluggable_type_and_scope UNIQUE  (slug(70),sluggable_type,`scope`(70)),
...
CREATE TABLE lists (
  id bigint NOT NULL DEFAULT NEXTVAL ('lists_seq'),
  title_id bigint DEFAULT NULL,
  user_id bigint DEFAULT NULL,
  created_at timestamp(0) NOT NULL,
  updated_at timestamp(0) NOT NULL,
...
ALTER SEQUENCE lists_seq RESTART WITH 6;
/*!40101 SET character_set_client = @saved_cs_client */;

CREATE INDEX index_lists_on_title_id ON lists (title_id);
CREATE INDEX index_lists_on_user_id ON lists (user_id);
...
CREATE TABLE options (
  id bigint NOT NULL DEFAULT NEXTVAL ('options_seq'),
  name text,
  user_id bigint DEFAULT NULL,
...
ALTER SEQUENCE options_seq RESTART WITH 35;
/*!40101 SET character_set_client = @saved_cs_client */;

CREATE INDEX index_options_on_user_id ON options (user_id);
CREATE INDEX index_options_on_episode_id ON options (episode_id);
...
CREATE TABLE seasons (
  id bigint NOT NULL DEFAULT NEXTVAL ('seasons_seq'),
  name text,
  number int DEFAULT NULL,
  user_id bigint DEFAULT NULL,
  title_id bigint DEFAULT NULL,
...
ALTER SEQUENCE seasons_seq RESTART WITH 4;
/*!40101 SET character_set_client = @saved_cs_client */;

CREATE INDEX index_seasons_on_user_id ON seasons (user_id);
CREATE INDEX index_seasons_on_title_id ON seasons (title_id);
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE SEQUENCE subtitles_seq;

CREATE TABLE subtitles (
  id bigint NOT NULL DEFAULT NEXTVAL ('subtitles_seq'),
  episode_id bigint DEFAULT NULL,
...
ALTER SEQUENCE subtitles_seq RESTART WITH 87;
/*!40101 SET character_set_client = @saved_cs_client */;

CREATE INDEX index_subtitles_on_episode_id ON subtitles (episode_id);
...
CREATE TABLE taggings (
  id int NOT NULL DEFAULT NEXTVAL ('taggings_seq'),
...
ALTER SEQUENCE taggings_seq RESTART WITH 10;
/*!40101 SET character_set_client = @saved_cs_client */;
...
ALTER SEQUENCE tags_seq RESTART WITH 9;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE titles (
  id bigint NOT NULL DEFAULT NEXTVAL ('titles_seq'),
  name text,
  synopsis text,
  alternative text,
  ...
  cached_votes_total int DEFAULT '0',
  cached_votes_score int DEFAULT '0',
  cached_votes_up int DEFAULT '0',
  cached_votes_down int DEFAULT '0',
  cached_weighted_score int DEFAULT '0',
  cached_weighted_total int DEFAULT '0',
  cached_weighted_average double precision DEFAULT '0',
  PRIMARY KEY (id)
 ,
  CONSTRAINT fk_rails_4926f23134 FOREIGN KEY (user_id) REFERENCES users (id)
)  ;

ALTER SEQUENCE titles_seq RESTART WITH 5;
/*!40101 SET character_set_client = @saved_cs_client */;

CREATE INDEX index_titles_on_user_id ON titles (user_id);
...
CREATE TABLE users (
  ...
  reset_password_sent_at timestamp(0) DEFAULT NULL,
  remember_created_at timestamp(0) DEFAULT NULL,
  created_at timestamp(0) NOT NULL,
  updated_at timestamp(0) NOT NULL,
...
CREATE TABLE votes (
  id int NOT NULL DEFAULT NEXTVAL ('votes_seq'),
  votable_type varchar(255) DEFAULT NULL,
  votable_id int DEFAULT NULL,
  voter_type varchar(255) DEFAULT NULL,
  voter_id int DEFAULT NULL,
  vote_flag smallint DEFAULT NULL,
